...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "5621979401:AAFtOK1tUX-n1wES2ODVtx_VoLUEci5sJRY") 
...
OWNER_ID = os.environ.get("OWNER_ID", "5656382791")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME", "Flylong")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP", "NOOBCREATOR")
BOT_NAME = os.environ.get("BOT_NAME", "ELLA CHAT BOT")
START_IMG1 = os.environ.get("START_IMG1", "https://te.legra.ph/file/a613422945809f932fe05.jpg")
START_IMG2 = os.environ.get("START_IMG2", "https://te.legra.ph/file/6ce5a57b1ec1002736313.jpg")
START_IMG3 = os.environ.get("START_IMG3", "https://te.legra.ph/file/91af106626d4d2e761f8a.jpg")
START_IMG4 = os.environ.get("START_IMG4", "https://te.legra.ph/file/8a7167034ea27adf53b40.jpg")
START_IMG5 = os.environ.get("START_IMG5", "https://te.legra.ph/file/5075a627faa2658a56bb8.jpg")
START_IMG6 = os.environ.get("START_IMG6", "https://te.legra.ph/file/166fb38fd6ff4209e0a58.jpg")
START_IMG7 = os.environ.get("START_IMG7", "https://te.legra.ph/file/a8e5906ba5b1e31ba620e.jpg")
START_IMG8 = os.environ.get("START_IMG8", "https://te.legra.ph/file/ae65ece77a8b5351ec1e9.jpg")
START_IMG9 = os.environ.get("START_IMG9", "https://te.legra.ph/file/84278609045eb258e1b3c.jpg")
START_IMG10 = os.environ.get("START_IMG10", "https://te.legra.ph/file/c1ec26917ed627343fa3d.jpg")
...
DEV_OP = [
    ...
    [
        InlineKeyboardButton(text="✰ ʜᴇʟᴘs & ᴄᴏᴍᴍᴀɴᴅs✰ ", callback_data="HELP"),
    ],
    [
        InlineKeyboardButton(text="✰ sᴏᴜʀᴄᴇ ✰", callback_data="SOURCE"),
        InlineKeyboardButton(text="✰ ᴍʏ ɪɴғᴏ ✰", callback_data="ABOUT"),
    ],
]
PNG_BTN = [
    [
...
HELP_BUTN = [
     [
           InlineKeyboardButton(text="✰ ʜᴇʟᴘs & ᴄᴏᴍᴍᴀɴᴅs ✰", url=f"https://t.me/{BOT_USERNAME}?start=help"),
           InlineKeyboardButton(text="✰ ᴄʟᴏsᴇ ✰", callback_data="CLOSE"),
     ],
]
...
ABOUT_BTN = [
      ...
      [    
           InlineKeyboardButton(text="✰ ᴍʏ ᴏᴡɴᴇʀ ✰", url=f"https://t.me/{OWNER_USERNAME}"), 
           InlineKeyboardButton(text="✰ sᴏᴜʀᴄᴇ ✰", callback_data="SOURCE"),
      ],
      [ 
...
print(f"{BOT_NAME} ɪs ᴀʟɪᴠᴇ! ᴀɴʏ ɪssᴜᴇ ᴛʜᴇɴ ᴠɪsɪᴛ sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ [ɴᴏᴏʙᴄʀᴇᴀᴛᴏʀ](t.me/noobcreator)")      
bot.run()
